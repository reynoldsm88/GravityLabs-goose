...
class GoldSitesTestIT {
    ...
    def yahoo( ) {
        ...
        TestUtils.runArticleAssertions( article = article,
                                        ...
                                        expectedImage = "http://l1.yimg.com/bt/api/res/1.2/rQjGYdY_uYh6LpCnzkGFvQ--/YXBwaWQ9eW5ld3M7Zmk9ZmlsbDtoPTc1O3E9ODU7dz0xMDA-/http://media" +
                                                        ".zenfs.com/en_us/News/ap_webfeeds/89854c5c8090bd15df0e6a706700dfbc.jpg" )
    }
    ...
    def businessInsider( ) {
        ...
        TestUtils.runArticleAssertions( article = article,
                                        ...
                                        expectedImage = "http://static7.businessinsider" +
                                                        ".com/image/4df5d311ccd1d5591f190000/major-rally-collapses-ahead-of-huge-day-heres-what-you-need-to-know.jpg" )
        TestUtils.printReport()
    }
