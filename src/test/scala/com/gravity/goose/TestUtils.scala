...
object TestUtils {
    ...
    def runArticleAssertions( article : Article, expectedTitle : String = null, expectedStart : String = null, expectedImage : String = null, expectedDescription : String = null,
