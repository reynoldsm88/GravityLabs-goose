...
abstract class PublishDateExtractor extends Extractor[ Date ] {
    /**
      ...
      * <p>This will be called by the {@link com.jimplush.goose.ContentExtractor#extractContent(String)} method and will be passed to {@link com.jimplush.goose
      * .Article#setPublishDate(java.util.Date)}</p>
      *
